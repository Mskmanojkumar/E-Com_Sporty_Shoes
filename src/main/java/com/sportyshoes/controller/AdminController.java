...
public class AdminController {
	...
	@GetMapping("/shoes/categorize/{category}")
	public ResponseEntity<List<Product>> getAllShoesBasedOnCategory(@PathVariable("category") String category) {
	...
	@PostMapping("/shoes")
	public ResponseEntity<Product> addShoes(@RequestBody Product product) {
	...
	public ResponseEntity<Product> getShoesById(@PathVariable("productId") int id) {
	...
	@DeleteMapping("/shoes/{productId}")
	public ResponseEntity<HttpStatus> deleteShoesById(@PathVariable("productId") int id) {
		productService.deleteProductById(id);
		return new ResponseEntity<>(HttpStatus.OK);
	}

	@GetMapping("/users")
	public ResponseEntity<List<User>> getAllRegistredUsers() {
	...
	public ResponseEntity<User> getRegistredUser(@PathVariable String userName) {
